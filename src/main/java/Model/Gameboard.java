...
public class Gameboard {
    ...
    private final ArrayList<InfectionCard> infectionDiscardStack;
    private final ArrayList<PlayerCard> playerStack;
    private final ArrayList<PlayerCard> playerDiscardStack;
    private int outbreakCounter = 0;
    private int infectionRate = 0;
    private final ArrayList<City> citiesWithResearchStations;
    private final ArrayList<City> citiesToAddCubesTo;

    public Gameboard(ArrayList<City> cities, ArrayList<Cure> cures, ArrayList<InfectionCard> infectionStack, ArrayList<InfectionCard> infectionDiscardStack, ArrayList<PlayerCard> playerStack, ArrayList<PlayerCard> playerDiscardStack, ArrayList<City> citiesWithResearchStations, ArrayList<City> citiesToAddCubesTo) {
        this.cities = cities;
        this.cures = cures;
